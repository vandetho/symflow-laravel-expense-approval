    ...
    <div class="grid gap-6 lg:grid-cols-3">
        ...
        <div class="space-y-6">
            ...
            <div class="rounded-2xl border border-zinc-200 bg-white p-4 shadow-xs">
                ...
                <p class="mt-1 text-xs text-zinc-500">Inspect the canonical canvas at <a href="https://symflowbuilder.com/w/9e50940e6f0e0d02" target="_blank" rel="noopener" class="font-medium text-emerald-700 hover:underline">symflowbuilder.com</a> — sign in there to fork and edit your own copy.</p>
            </div>
        </div>
    </div>
</div>
