...
class WorkflowServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        foreach ($registry->all() as $workflow) {
            ...
            // Demo of the Workflow event system: log every "entered" hop.
            // In a real app this would dispatch notifications, emails, queued jobs.
            $workflow->on(WorkflowEventType::Entered, function (SubjectEvent $event): void {
                if (! $event->subject instanceof ExpenseRequest) {
                    return;
                }

                Log::info('expense.entered', [
                    'expense_id' => $event->subject->getKey(),
